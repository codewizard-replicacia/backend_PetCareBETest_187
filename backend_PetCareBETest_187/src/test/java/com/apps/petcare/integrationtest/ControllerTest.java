package com.apps.petcare.integrationtest;
...
import com.apps.petcare.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("PetCareBETest", n.getAttribute("Namespace"));
  ...
  void  testCreatePetServiceInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCareBETest/PetServices")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareBETest/PetServices?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/PetCareBETest/PetServices/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareBETest/PetOwners?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareBETest/PetOwners/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreatePetCareCenterInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCareBETest/PetCareCenters")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareBETest/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareBETest/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareBETest/Documents?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareBETest/Documents/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  teardown() {
    ...
    jdbcTemplate.execute("DELETE FROM petcare.Pet");
     ...
     jdbcTemplate.execute("DELETE FROM petcare.PetCareCenterBusinessHours");
